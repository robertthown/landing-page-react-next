    ...
    return(
            <section className="w-full h-[704px] bg-img_bg_hero bg-no-repeat bg-center bg-cover flex justify-center ">
                    <div className="flex items-center justify-center">
                        <form className="w-full mx-auto bg-[#106db0d2] p-20 rounded-2xl text-white">
                            ...
                            <input type="text" id="nome" name="nome" className="border rounded py-2 px-3 w-full" />
                            </div>

                            <div className="mb-4">
                                <label className="block text-sm font-bold mb-2">Email:</label>
                                <input type="email" id="email" name="email" className="border rounded py-2 px-3 w-full" />
                            </div>

                            <div className="mb-4">
                                <label className="block text-sm font-bold mb-2">Telefone:</label>
                                <input type="telefone" id="telefone" name="telefone" className="border rounded py-2 px-3 w-full" />
                            </div>
